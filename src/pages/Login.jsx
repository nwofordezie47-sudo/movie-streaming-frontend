    ...
    const handleGoogleSignIn = () => {
        ...
        if (!window.google) {
            ...
            setModalState({
                ...
                message: 'Google Sign-In SDK is not loaded. Please refresh the page.',
                type: 'error'
            });
            return;
        }
        ...
        <div className="auth-page">
            ...
            <div className="auth-left">
                <div className="auth-left-content">
                    <h1>Welcome back to DanStream</h1>
                    <p>Discover the latest films and exclusive content. Your cinematic journey continues here.</p>
                </div>
            </div>
